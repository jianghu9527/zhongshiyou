package com.efficient.production.app.model.adapter
...
class FlowAdapterFactory private constructor(private val async: Boolean) :
    ...
    override fun get(
        ...
        return if (rawFlowType == Response::class.java) {
            ...
            com.efficient.production.app.model.adapter.FlowCallAdapter(
                responseBodyType,
                false,
                async
            )
        } else {
            com.efficient.production.app.model.adapter.FlowCallAdapter(flowType, true, async)
        }
    ...
    companion object {
        ...
        fun create(async: Boolean = false) =
            com.efficient.production.app.model.adapter.FlowAdapterFactory(async)
    }
}